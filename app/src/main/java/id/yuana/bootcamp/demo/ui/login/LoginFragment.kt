package id.yuana.bootcamp.demo.ui.login
...
import id.yuana.bootcamp.demo.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment(R.layout.fragment_login) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appModule = (requireActivity().application as DemoApp).appModule
        viewModel = LoginViewModel(appModule.provideAuthRepository())
